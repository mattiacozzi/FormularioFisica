...
%   \[ v_{finale} = \dfrac{m_1 v_0 + m_2 w_0}{m_1 + m_2} \]
...
% \end{figure}
  ...
  \item[Trasformazione isocora] $ \Delta U = Q $%. Grafico in \Cref{img:isocora}.
%
% \begin{figure}[htp]\centering
...
% \end{figure}
  ...
  \item[Trasformazione isoterma] $ Q = L $%. Grafico in \Cref{img:isoterma}.
%
% \begin{figure}[htp]\centering
...
% \end{figure}
  ...
  \item[Trasformazione adiabatica] $ \Delta U = - L $%. Grafico in \Cref{img:adiabatica}.
%
% \begin{figure}[htp]\centering
...
% \end{figure}
  ...
  \item[Trasformazione ciclica] $ Q = L $%. Grafico in \Cref{img:ciclica}.
%
% \begin{figure}[htp]\centering
...
%   Se il campo $ B $ e la corrente $ i $ che scorre in un filo lungo $ \ell $ sono perpendicolari, vale:
...
%   $ \lambda = \dfrac{h}{p} $% Tale lunghezza d'onda è detta \emph{lunghezza d'onda di De Broglie} della particella.
%   
