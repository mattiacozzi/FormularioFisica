...
\usepackage{hyperref}
\newbool{semplificato}
\setbool{semplificato}{false} %true/false = semplificato/completo
...
\begin{soloscientifico} %INIZIO PARTE SOLO PER LO SCIENTIFICO
...
\end{soloscientifico}   %FINE PARTE SOLO PER LO SCIENTIFICO
\end{description}
...
%   \end{itemize}
  ...
  \[ L = \vec{F} \cdot \vec{s} = q \vec{E} \cdot \vec{s}  \]\end{soloscientifico}   %FINE PARTE SOLO PER LO SCIENTIFICO
...
\end{soloscientifico}   %FINE PARTE SOLO PER LO SCIENTIFICO
  ...
  \item[Effetto Joule] 
  È la trasformazione di energia potenziale elettrica in energia termica (calore).\begin{soloscientifico} %INIZIO PARTE SOLO PER LO SCIENTIFICO
