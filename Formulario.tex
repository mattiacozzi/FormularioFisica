...
\begin{description}
  ...
  Oltre alle trasformazioni già riportate in \Cref{tab:trasformazioni} a \cpageref{tab:trasformazioni}, aggiungiamo le trasformazioni \emph{adiabatiche} (senza scambi di calore con l'ambiente) e quelle \emph{cicliche} (che iniziano e finiscono con gli stessi valori delle variabili di stato).
...
\begin{description}
  ...
  Nella \Cref{img:radianza} la zona centrale indica lo spettro della luce visibile: alla sua sinistra la radiazione ultravioletta, alla sue destra i raggi infrarossi.
